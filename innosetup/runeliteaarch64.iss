...
OutputDir=${basedir}
OutputBaseFilename=EldritchSetupAArch64

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-aarch64\Eldritch.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${basedir}\build\win-aarch64\Eldritch.jar"; DestDir: "{app}"
...
[UninstallDelete]
Type: filesandordirs; Name: "{%USERPROFILE}\.eldritch1\repository2"
